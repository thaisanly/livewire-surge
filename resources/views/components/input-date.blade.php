<div class="mt-1 relative rounded-md shadow-sm">
    ...
    <!-- We are only initializing PikaDay when it is needed because otherwise it will
         fire a "change" event on page load. It's really dumb. -->
    <input
        {{ $attributes }}
        x-data
        x-on:focus="new Pikaday({ field: $refs.picker, format: 'MM/DD/YYYY' })"
        x-ref="picker"
        autocomplete="off"
        class="form-input block w-full pl-10 sm:text-sm sm:leading-5" placeholder="MM/DD/YYYY"
    />
</div>
